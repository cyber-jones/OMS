...
import { approvePrescription, deletePrescription, disapprovePrescription, getDoctorPrescriptions, getPatientPrescriptions, getPrescription, getPrescriptions, postPrescription, updatePrescription } from '../controllers/prescriptionController.js';
...
prescriptionRouter.get("/doctor/:id", verifyRoles([ROLES[0], ROLES[1]]), getDoctorPrescriptions);
