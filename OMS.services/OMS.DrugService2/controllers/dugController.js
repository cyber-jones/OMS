...
export const postDrug = async (req, res, next) => {
    try {
        ...
        return res.status(201).json({ success: true, drug: newDrug, message: "Drug created successfully" });
    } catch (err) {
        next(err);
    }
}  
...
export const updateDrug = async (req, res, next) => {
    try {
        ...
        return res.status(205).json({ success: true, drug: updateDrug, message: "Drug updated successfully" });
    } catch (err) {
        next(err);
    }
}
...
export const deleteDrug = async (req, res, next) => {
    try {
        ...
        return res.status(200).json({ success: true, message: "Drug deleted successfully" });
    } catch (err) {
        next(err);
    }
}  
